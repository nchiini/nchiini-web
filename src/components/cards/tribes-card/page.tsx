...
const Card = ({ title, description, imageUrl, id }: any) => {
  return (
    <Link href={"/tribes/" + id + "?tab=Origin"} className="w-full flex flex-col gap-2 border hover:border-white/40 cursor-pointer border-white/10 rounded-3xl p-3 bg-grey-2">
